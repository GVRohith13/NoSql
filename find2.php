...
<br><br>
           ...
           <br><br>
           <h4>SELECT A STRING FIELD AND ITS RESPECTIVE VALUE</h4>
<br>
           <input list="browsersN" id="listnd" name="listnd" placeholder="select an item">
...
<br><br>
            <input type="text" name="n2" id="n2" placeholder="Enter n value">
           <br><br>
...
$filter2 = array('$and'=>array([$ab=>$n],
                            [$abd => $n2]));

$cursor = $tbl->find($filter2);
